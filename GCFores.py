...
class gcForest(object):
    ...
    def __init__(self, shape_1X=None, n_mgsRFtree=30, window=None, stride=1, weight=1, n_layer=5,
    ...
    def window_slicing_pred_prob(self, X, window, shape_1X, y=None):
        ...
        if y is not None:
            ...
            prf = RandomForestClassifier(n_estimators=n_tree, max_features='sqrt', class_weight={0: 1, 1: self.weight},
                                         min_samples_split=min_samples, oob_score=True, n_jobs=n_jobs)
            crf = RandomForestClassifier(n_estimators=n_tree, max_features="log2", class_weight={0: 1, 1: self.weight},
                                         min_samples_split=min_samples, oob_score=True, n_jobs=n_jobs)
